...
The color scales above might not be the best for distinguishing between the different categories. However, we include the setting here to show the utility of the available color scales incorporated in the package.
...
The first level shows some very general groupings of the contigs. Let's visualize each one.

```{r, fig.width=8, fig.height=8, out.width="80%", fig.align="center"}
qaanaaq_annotree |>
  vis_abundance(group_x = "SampleName",
                group_split = "Wetness",
                level_glom = "Brite_Level2",
                level_select = "Brite_Level1",
                group_select = c("Genetic information processing",
                                 "Metabolism",
