...
From the above, we can see that proteobacteria take over the community for large concentrations. Let's see what happens for those as well as the eukaryotes. The represented kingdoms can be seen below.
