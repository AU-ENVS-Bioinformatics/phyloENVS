...
```{r example1, fig.cap="Relative abundance plot.", out.width = "80%", fig.path = "man/figures/README-", fig.align="center"}
library(phyloENVS)
...
```{r example2, fig.cap="NMDS plot.", out.width = "80%", fig.path = "man/figures/README-", message=FALSE, fig.align="center"}
