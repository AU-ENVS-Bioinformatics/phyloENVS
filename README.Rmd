...
```{r example1, fig.align="center", fig.cap="Relative abundance plot.", out.width = "70%", fig.path = "man/figures/README-", fig.align="center"}
library(phyloENVS)
...
```{r example2, fig.align="center", fig.cap="NMDS plot.", out.width = "70%", fig.path = "man/figures/README-", message=FALSE, echo=FALSE}
