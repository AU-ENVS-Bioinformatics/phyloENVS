...
This package builds upon the [phyloseq package](https://joey711.github.io/phyloseq/). Furthermore, this work has been highly inspired by the [RauENVS package](https://github.com/AU-ENVS-Bioinformatics/RauENVS).
