...
All functions within phyloENVS builds upon the phyloseq package for microbial community analysis. The phyloseq data structure in R organizes multi-table datasets into a single coherent object. The components of a phyloseq object are listed below and visualized below.
